...
export function LoginForm() {
    ...
    return (
        <Card className="w-full max-w-md mx-auto shadow-xl bg-white/90 backdrop-blur-md border-0">
            ...
            <CardContent className="space-y-4 pt-4">
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                                    ...
                                    <FormControl>
                                        <div className="relative">
                                            ...
                                            <Input
                                                ...
                                                className="pl-10 py-6 bg-gray-50 border-gray-200 focus:bg-white transition-all"
                                                {...field}
                                                onChange={(e) => {
                                                    clearError()
                                                    field.onChange(e)
                        ...
                        <Button
                            type="submit"
                            className="w-full mt-6 py-6 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 transition-all shadow-md"
                            disabled={isLoading}
                        >
